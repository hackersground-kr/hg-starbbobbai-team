...
14. 이렇게 하게 되면 환경설정이 끝나게 된다.
![image](https://github.com/user-attachments/assets/37d84312-63fc-4f99-8de9-f8dcaf99cf64)

15. 아래에 사진에 따라 open...을 클릭한다.
![image](https://github.com/user-attachments/assets/12ebb51a-37d8-42f6-ae3a-dc5028adec31)

16. 사진처럼 화면이 뜨게된다.
![image](https://github.com/user-attachments/assets/63385ce3-ec2a-480a-80b7-6dba5b5ae1ef)

17. 우리가 위에서 설치한 파일이 다운로드에 있으니 다운로드를 항목을 클릭한다.
![image](https://github.com/user-attachments/assets/0d6116fc-8f37-4e83-83df-1aa638999bc7)

18. 다운로드에 우리가 설치한 파일을 클릭한다.
19. 그리고 오른쪽 아래에 열기 버튼을 누른다.
20. 만약 아래 사진과 같이 뜨게 된다면 맨 오른족에 있는 버튼을 클릭한다.
![image](https://github.com/user-attachments/assets/747998db-7461-4e57-afd5-9a423a58b57a)

22. 버튼이 세개가 나오게 되는데 this window, new window중에서 선택하면 된다.
23. 그러면 여러분은 코드를 열게 되었습니다.
